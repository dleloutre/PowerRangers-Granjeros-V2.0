...
public:
	...
	//pre: el cultivo está en la lista de cultivos y el agua disponible en el tanque es mayor a las unidades de riego
	//     necesarias para el cultivo.

	//post: utiliza las unidades de agua requeridas

	int utilizarAgua(Lista<Cultivo*>* cultivos, char cultivoParcela);
